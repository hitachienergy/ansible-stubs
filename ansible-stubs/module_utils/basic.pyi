# This file was generated by stubgen and then modified manually.
...
def heuristic_log_sanitize(data, no_log_values: list[str] | set[str] | None = None) -> str: ...
def _load_params(): ...
...
class AnsibleModule:
    ...
    required_if: list[tuple[Incomplete]]
    required_by: dict[str, str | tuple[str]]
    cleanup_files: list[StrOrBytesPath]
    _debug: bool
    _diff: bool
    ...
    def __init__(self, argument_spec: dict[str, dict[str, Any]], bypass_checks: bool = False, no_log: bool = False, mutually_exclusive: list[tuple[str]] | None = None, required_together: list[tuple[str]] | None = None, required_one_of: list[tuple[str]] | None = None, add_file_common_args: bool = False, supports_check_mode: bool = False, required_if: list[tuple[Incomplete]] | None = None, required_by: dict[str, str | tuple[str]] | None = None) -> None: ...
    @property
    def tmpdir(self): ...
    ...
    def _set_cwd(self): ...
    def get_bin_path(self, arg: str, required: bool = False, opt_dirs: list[str] | None = None) -> str | None | NoReturn: ...
    ...
    def atomic_move(self, src, dest, unsafe_writes: bool = False, keep_dest_attrs: bool = True) -> None: ...
    def _unsafe_writes(self, src, dest) -> None: ...
    def _clean_args(self, args: list[str] | str | bytes) -> str: ...
    def run_command(self, args: list[str] | str, check_rc: bool = False, close_fds: bool = True, executable: Incomplete | None = None, data: Incomplete | None = None, binary_data: bool = False, path_prefix: Incomplete | None = None, cwd: Incomplete | None = None, use_unsafe_shell: bool = False, prompt_regex: Incomplete | None = None, environ_update: Incomplete | None = None, umask: Incomplete | None = None, encoding: str = 'utf-8', errors: str = 'surrogate_or_strict', expand_user_and_vars: bool = True, pass_fds: Incomplete | None = None, before_communicate_callback: Incomplete | None = None, ignore_invalid_cwd: bool = True, handle_exceptions: bool = True) -> tuple[int, str, str] | NoReturn: ...
